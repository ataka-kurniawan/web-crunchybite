...
<section class="hero d-flex align-items-center justify-content-center text-center text-white"
    ...
    <div class="hero-content">
        ...
        <p data-aos="fade-in" data-aos-delay="700">Kami Menghidangkan Kelezatan Pastri & Kue dengan Sentuhan Istimewa</p>
        <a href="/web-crunchybite/product.php"
            class="btn-cta px-4 py-2 rounded-pill text-light mt-3" onclick="alert('halo saya putri suria lestari dengan nim 2311103077')"
