...
<!-- Hero Section -->
<section class="hero-c d-flex align-items-center justify-content-center text-center text-white">
    <h1 class="hero-c-content">CONTACT US</h1>
</section>
...
<section class="contact-us">
    <div class="contact-container">
        <h2>Hubungi Kami</h2>
        <p>Feel free to reach out to us through our social media platforms or WhatsApp.</p>
        ...
        <br>
        <a href="https://wa.me/your-number" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="30"
                height="30" viewBox="0 0 256 258">
                <defs>
